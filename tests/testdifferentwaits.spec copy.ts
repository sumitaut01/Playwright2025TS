...
test('wait for timeout', async ({ page }) => {
    ...
    page.waitForLoadState('networkidle'); 
     // this will wait for the network to be idle, it will wait for all the network requests to be 
     // completed before moving to next step
    ...
    page.waitForSelector('text=Swag Labs');  // this will wait for the element to be visible, 
    // if the element is already visible it will not wait and move to next step  
})          ;
